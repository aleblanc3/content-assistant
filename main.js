...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-L4KFPAVU.js").then((m) => m);
...
</fieldset>`, styles: ["/* angular:styles/component:css;49a6573b5384514cd7691e34ae77690c7832d93287784bea6bcab8477465a06c;C:/AmberDev/content-assistant/src/app/views/image-assistant/components/file-upload/file-upload.component.ts */\n.file-upload-container {\n  border: 2px dashed #ccc;\n  border-radius: 8px;\n  padding: 2rem;\n  text-align: center;\n  cursor: pointer;\n  transition: all 0.3s ease;\n  margin-top: 1rem;\n}\n.file-upload-container:hover {\n  border-color: #a7a72e;\n  background-color: #f5f5f5;\n}\n.file-upload-container.dragover {\n  border-color: #a7a72e;\n  background-color: #f0f0f0;\n}\ninput[type=file] {\n  display: none;\n}\n.upload-icon {\n  font-size: 3rem;\n  color: #a7a72e;\n  margin-bottom: 1rem;\n}\nfieldset {\n  border: none;\n  padding: 0;\n  margin: 0;\n}\nlegend {\n  font-weight: bold;\n  margin-bottom: 0.5rem;\n}\n/*# sourceMappingURL=file-upload.component.css.map */\n"] }]
  }], null, { filesSelected: [{
    type: Output
  }] });
})();
...
</div>`, styles: ["/* angular:styles/component:css;1645e8db0489e01d241bf83ede0fef27d6588e9d7870f9c030b5919ea8047f7f;C:/AmberDev/content-assistant/src/app/views/image-assistant/components/image-result/image-result.component.ts */\n.result-container {\n  margin-bottom: 2rem;\n}\n.result-image {\n  max-height: 200px;\n  width: auto;\n  border: 1px solid #eee;\n  margin-bottom: 1rem;\n  display: block;\n  border-radius: 4px;\n}\n.result-columns {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  gap: 2rem;\n}\n@media (max-width: 768px) {\n  .result-columns {\n    grid-template-columns: 1fr;\n    gap: 1rem;\n  }\n}\n.result-column {\n  background-color: #f8f9fa;\n  padding: 1rem;\n  border-radius: 8px;\n}\n.collapsible-container {\n  margin: 0.5rem 0;\n}\n.processing-message {\n  display: flex;\n  align-items: center;\n  gap: 1rem;\n}\n.copy-button {\n  margin-top: 0.5rem;\n}\n/*# sourceMappingURL=image-result.component.css.map */\n"] }]
...
</div>`, styles: ["/* angular:styles/component:css;1c997a74d74a98c53de94cd1b23dcec12d9454b472a147986b6d5799e58fa7ae;C:/AmberDev/content-assistant/src/app/views/image-assistant/components/csv-download/csv-download.component.ts */\n.csv-download-container {\n  margin-top: 2rem;\n  padding: 1rem;\n  background-color: var(--surface-100);\n  border-radius: 8px;\n}\n/*# sourceMappingURL=csv-download.component.css.map */\n"] }]
...
</section>`, styles: ["/* angular:styles/component:css;09dc9166e46b9e7aabdb069b1dc488d36e7e0913816855e9dc9912d983b17aa9;C:/AmberDev/content-assistant/src/app/views/image-assistant/image-assistant.component.ts */\n.results-section {\n  margin-top: 2rem;\n}\n/*# sourceMappingURL=image-assistant.component.css.map */\n"] }]
...
var MetadataAssistantService = class _MetadataAssistantService {
  ...
  scrapeUrl(url) {
    ...
    return from(fetch(`${url}?_=${Date.now()}`)).pipe(timeout(this.SCRAPING_TIMEOUT), switchMap((response) => {
  ...
  extractTextContent(html) {
    ...
    allElements.forEach((el) => {
      if (el.tagName.toLowerCase() === "main") {
        mainTagFound = true;
        console.log("Found main element:", el.tagName, "with attributes:", Array.from(el.attributes).map((attr) => `${attr.name}="${attr.value}"`).join(" "));
      }
    });
    if (!mainTagFound) {
      ...
      roleMainDivs.forEach((el) => {
        console.log('Div with role="main" attributes:', Array.from(el.attributes).map((attr) => `${attr.name}="${attr.value}"`).join(" "));
      });
    }
  ...
  findMainElement(doc) {
    ...
    const selectorPriorities = [
      ...
      (el) => el.getAttribute("property") === "mainContentOfPage" && el.getAttribute("resource") === "#wb-main" && el.getAttribute("typeof") === "WebPageElement" && !el.classList.contains("col-md-9"),
      // Second priority: with specific classes
      (el) => el.getAttribute("property") === "mainContentOfPage" && el.getAttribute("resource") === "#wb-main" && el.getAttribute("typeof") === "WebPageElement" && el.classList.contains("col-md-9") && el.classList.contains("col-md-push-3"),
      // Third priority: role="main" with container class
      (el) => el.getAttribute("role") === "main" && el.getAttribute("property") === "mainContentOfPage" && el.classList.contains("container"),
      // Fourth priority: role="main" with property
      (el) => el.getAttribute("role") === "main" && el.getAttribute("property") === "mainContentOfPage"
    ];
...
French keywords (comma-separated):`;
  ...
  callOpenRouter(prompt, model, maxTokens, timeoutMs = this.API_TIMEOUT) {
    ...
    return this.http.post(this.OPENROUTER_URL, payload, { headers }).pipe(timeout(timeoutMs), retry({
      count: 2,
      delay: (error, retryCount) => {
        if (error.status === 404 || error.error?.error?.message && error.error.error.message.includes("No endpoints found")) {
          console.log(`Retrying API call (attempt ${retryCount + 1}) after transient error`);
          return timer(1e3 * retryCount);
        }
        throw error;
      }
    }), map((response) => {
  ...
  cleanKeywordsResponse(response) {
    ...
    if (keywordsString.length > 400) {
      ...
      for (const keyword of keywords) {
        const newLength = currentLength + (currentLength > 0 ? 2 : 0) + keyword.length;
        if (newLength <= 400) {
...
function MetadataAssistantComponent_span_11_Template(rf, ctx) {
  if (rf & 1) {
...
function MetadataAssistantComponent_section_15_div_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 19)(1, "p-button", 20);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275listener("onClick", function MetadataAssistantComponent_section_15_div_10_Template_p_button_onClick_1_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(2);
...
function MetadataAssistantComponent_section_15_div_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div");
    \u0275\u0275element(1, "ca-progress-indicator", 21);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function MetadataAssistantComponent_section_15_div_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 13);
    \u0275\u0275element(1, "p-message", 22);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function MetadataAssistantComponent_section_15_div_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 23);
    \u0275\u0275element(1, "ca-metadata-result", 24)(2, "ca-metadata-csv-export", 25);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function MetadataAssistantComponent_section_15_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "section")(1, "div", 10)(2, "div", 11)(3, "ca-url-input", 12);
    \u0275\u0275listener("urlsChange", function MetadataAssistantComponent_section_15_Template_ca_url_input_urlsChange_3_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onUrlsChange($event));
    })("urlInputChange", function MetadataAssistantComponent_section_15_Template_ca_url_input_urlInputChange_3_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onUrlInputChange($event));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 13)(5, "ca-shared-model-selector", 14);
    \u0275\u0275listener("modelChange", function MetadataAssistantComponent_section_15_Template_ca_shared_model_selector_modelChange_5_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onModelChange($event));
    })("translateChange", function MetadataAssistantComponent_section_15_Template_ca_shared_model_selector_translateChange_5_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onTranslateToggle($event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 13)(7, "p-button", 15);
    \u0275\u0275pipe(8, "translate");
    \u0275\u0275pipe(9, "translate");
    \u0275\u0275listener("onClick", function MetadataAssistantComponent_section_15_Template_p_button_onClick_7_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.startProcessing());
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275template(10, MetadataAssistantComponent_section_15_div_10_Template, 3, 4, "div", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "div", 11);
    \u0275\u0275template(12, MetadataAssistantComponent_section_15_div_12_Template, 2, 5, "div", 4)(13, MetadataAssistantComponent_section_15_div_13_Template, 2, 1, "div", 17);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(14, MetadataAssistantComponent_section_15_div_14_Template, 3, 4, "div", 18);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function MetadataAssistantComponent_div_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 26);
    \u0275\u0275element(1, "p-message", 27);
    \u0275\u0275pipe(2, "translate");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var MetadataAssistantComponent = class _MetadataAssistantComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MetadataAssistantComponent, selectors: [["ca-metadata-assistant"]], decls: 19, vars: 21, consts: [["id", "wb-cont"], [1, "api-key-status", "mb-4"], ["class", "text-green-600", 4, "ngIf"], ["class", "text-orange-600", 4, "ngIf"], [4, "ngIf"], ["class", "mt-4", 4, "ngIf"], [1, "text-green-600"], [1, "pi", "pi-check-circle"], [1, "text-orange-600"], [1, "pi", "pi-exclamation-circle"], [1, "grid"], [1, "col-12", "lg:col-6"], [3, "urlsChange", "urlInputChange", "disabled"], [1, "mt-3"], [3, "modelChange", "translateChange", "selectedModel", "models", "label", "cardTitle", "showCard", "showTranslateOption", "translateToFrench", "disabled"], ["icon", "pi pi-sparkles", "severity", "primary", "styleClass", "w-full", 3, "onClick", "label", "disabled", "loading"], ["class", "mt-2", 4, "ngIf"], ["class", "mt-3", 4, "ngIf"], ["class", "results-section mt-4", 4, "ngIf"], [1, "mt-2"], ["icon", "pi pi-refresh", "severity", "secondary", "styleClass", "w-full", 3, "onClick", "label", "outlined"], [3, "progressText", "processedCount", "totalFiles", "showProgress", "showSpinner"], ["severity", "error", "styleClass", "w-full", 3, "text"], [1, "results-section", "mt-4"], [3, "results", "showTranslations"], [3, "results", "includeTranslations"], [1, "mt-4"], ["severity", "warn", "styleClass", "w-full", 3, "text"]], template: function MetadataAssistantComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275pipe(5, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(6, "section", 1)(7, "div")(8, "strong");
      \u0275\u0275text(9);
      \u0275\u0275pipe(10, "translate");
      \u0275\u0275elementEnd();
      \u0275\u0275template(11, MetadataAssistantComponent_span_11_Template, 4, 3, "span", 2);
      \u0275\u0275pipe(12, "async");
      \u0275\u0275template(13, MetadataAssistantComponent_span_13_Template, 4, 3, "span", 3);
      \u0275\u0275pipe(14, "async");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(15, MetadataAssistantComponent_section_15_Template, 15, 20, "section", 4);
      \u0275\u0275pipe(16, "async");
      \u0275\u0275template(17, MetadataAssistantComponent_div_17_Template, 3, 3, "div", 5);
      \u0275\u0275pipe(18, "async");
    }
    if (rf & 2) {
      \u0275\u0275advance();
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(2, 7, "metadata.title"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(5, 9, "metadata.description"));
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(10, 11, "page.apiKey.status"));
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", \u0275\u0275pipeBind1(12, 13, ctx.apiKeyService.hasApiKey$));
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", !\u0275\u0275pipeBind1(14, 15, ctx.apiKeyService.hasApiKey$));
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", \u0275\u0275pipeBind1(16, 17, ctx.apiKeyService.hasApiKey$));
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", !\u0275\u0275pipeBind1(18, 19, ctx.apiKeyService.hasApiKey$));
    }
  }, dependencies: [
    CommonModule,
    NgIf,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MetadataAssistantComponent, [{
    ...
    args: [{ selector: "ca-metadata-assistant", standalone: true, imports: [
      ...
      MetadataResultComponent,
      CsvExportComponent
    ], template: `<h1 id="wb-cont">{{ 'metadata.title' | translate }}</h1>\r
...
var routes = [
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-KHZOFRON.js").then((m) => m.PageAssistantCompareComponent)
  },
  {
...
(() => {
  ...
  `, styles: ["/* angular:styles/component:css;bba23d67f0c44f7da3fe1807e61603e3ec278e3a7974ab93a3b3cfcf38d3671d;C:/AmberDev/content-assistant/src/app/template/api-reset.component.ts */\n@media (max-width: 768px) {\n  ::ng-deep .api-button .p-button-label {\n    display: none;\n  }\n}\n::ng-deep .api-button:hover .p-button-icon {\n  color: var(--p-primary-400) !important;\n}\n::ng-deep html.dark-mode .api-button:hover .p-button-icon {\n  color: var(--p-primary-200) !important;\n}\n/*# sourceMappingURL=api-reset.component.css.map */\n"] }]
  }], () => [{ type: LocalStorageService }], null);
})();
(() => {
...
(() => {
  ...
  `, styles: ["/* angular:styles/component:css;607ff6dd9fa2de823f98ca3db927b4c2688fafc0a7c156a199ce40df64b470ce;C:/AmberDev/content-assistant/src/app/template/header.component.ts */\n::ng-deep .p-toolbar {\n  background-color: transparent !important;\n  border: none !important;\n}\nheader {\n  border-bottom-style: solid;\n  border-bottom-color: var(--p-gray-400);\n  border-width: 1px;\n  margin-top: -4rem;\n}\n::ng-deep .darkmode-toggle:hover .p-togglebutton-icon {\n  color: var(--p-cyan-400) !important;\n}\n::ng-deep html.dark-mode .darkmode-toggle:hover .p-togglebutton-icon {\n  color: var(--p-amber-400) !important;\n}\n/*# sourceMappingURL=header.component.css.map */\n"] }]
...
<footer class="container">
  ...
  `, styles: ["/* angular:styles/component:css;219558ef63f119a92210704329b58a3cdceaa4fb296db559e672f74512827dc7;C:/AmberDev/content-assistant/src/app/template/footer.component.ts */\n:host {\n  display: block;\n}\n/*# sourceMappingURL=footer.component.css.map */\n"] }]
  }], null, { darkMode: [{
    type: Input
  }] });
})();
...
(() => {
  ...
  <ca-header [darkMode]="isDarkMode" (darkModeToggled)="toggleDarkMode()"></ca-header>\r
  ...
  <ca-footer [darkMode]="isDarkMode"></ca-footer>\r
</body>\r
` }]
